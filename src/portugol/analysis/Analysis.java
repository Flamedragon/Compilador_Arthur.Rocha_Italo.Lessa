...
public interface Analysis extends Switch
{
    ...
    void caseAXComando(AXComando node);
    ...
    void caseATermoTermo(ATermoTermo node);
    void caseAFatorTermo(AFatorTermo node);
    void caseADiv(ADiv node);
    void caseAFatorFator(AFatorFator node);
    void caseAElemFator(AElemFator node);
    void caseAMult(AMult node);
    void caseAParentesesExpElem(AParentesesExpElem node);
    void caseAValorElem(AValorElem node);
    void caseAVarElem(AVarElem node);
    void caseAExpLogicaElem(AExpLogicaElem node);

...
public final class AComplementUnaryExpressionNotPlusMinus extends PUnaryExpressionNotPlusMinus
{
    private TNot _not_;
    private PUnaryExpression _unaryExpression_;

    public AComplementUnaryExpressionNotPlusMinus()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComplementUnaryExpressionNotPlusMinus(
    ...
    {
        ((Analysis) sw).caseAComplementUnaryExpressionNotPlusMinus(this);
    }

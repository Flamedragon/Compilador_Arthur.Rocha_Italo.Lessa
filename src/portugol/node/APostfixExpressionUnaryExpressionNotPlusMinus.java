...
public final class APostfixExpressionUnaryExpressionNotPlusMinus extends PUnaryExpressionNotPlusMinus
{
    private PPostfixExpression _postfixExpression_;

    public APostfixExpressionUnaryExpressionNotPlusMinus()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APostfixExpressionUnaryExpressionNotPlusMinus(
    ...
    {
        ((Analysis) sw).caseAPostfixExpressionUnaryExpressionNotPlusMinus(this);
    }

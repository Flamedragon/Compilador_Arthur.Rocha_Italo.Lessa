...
public final class ASadditiveExpressionRelationalExpression extends PRelationalExpression
{
    private PAdditiveExpression _additiveExpression_;

    public ASadditiveExpressionRelationalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASadditiveExpressionRelationalExpression(
    ...
    {
        ((Analysis) sw).caseASadditiveExpressionRelationalExpression(this);
    }

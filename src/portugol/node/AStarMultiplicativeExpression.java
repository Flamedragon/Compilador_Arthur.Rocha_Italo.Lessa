...
public final class AStarMultiplicativeExpression extends PMultiplicativeExpression
{
    private PMultiplicativeExpression _multiplicativeExpression_;
    private TStar _star_;
    private PUnaryExpression _unaryExpression_;

    public AStarMultiplicativeExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStarMultiplicativeExpression(
    ...
    {
        ((Analysis) sw).caseAStarMultiplicativeExpression(this);
    }

...
public final class AXorExpressionExpression extends PExpression
{
    private PExpression _l_;
    private PExpression _r_;

    public AXorExpressionExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AXorExpressionExpression(
            cloneNode(this._l_),
            cloneNode(this._r_));
    }
    ...
    {
        ((Analysis) sw).caseAXorExpressionExpression(this);
    }

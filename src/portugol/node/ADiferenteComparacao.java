...
public final class ADiferenteComparacao extends PComparacao
{
    private TNotEqual _notEqual_;

    public ADiferenteComparacao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADiferenteComparacao(
    ...
    {
        ((Analysis) sw).caseADiferenteComparacao(this);
    }

...
public final class AAndExpressionXorExpression extends PXorExpression
{
    private PAndExpression _andExpression_;

    public AAndExpressionXorExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAndExpressionXorExpression(
    ...
    {
        ((Analysis) sw).caseAAndExpressionXorExpression(this);
    }

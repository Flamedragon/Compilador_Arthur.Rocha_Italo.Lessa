...
public final class AUnaryExpressionMultiplicativeExpression extends PMultiplicativeExpression
{
    private PUnaryExpression _unaryExpression_;

    public AUnaryExpressionMultiplicativeExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUnaryExpressionMultiplicativeExpression(
    ...
    {
        ((Analysis) sw).caseAUnaryExpressionMultiplicativeExpression(this);
    }

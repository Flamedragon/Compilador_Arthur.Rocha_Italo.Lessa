...
public final class AAndExpressionExpression extends PExpression
{
    private PExpression _l_;
    private PExpression _r_;

    public AAndExpressionExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAndExpressionExpression(
            cloneNode(this._l_),
            cloneNode(this._r_));
    }
    ...
    {
        ((Analysis) sw).caseAAndExpressionExpression(this);
    }

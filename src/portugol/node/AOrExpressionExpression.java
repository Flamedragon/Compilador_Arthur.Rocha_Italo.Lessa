...
public final class AOrExpressionExpression extends PExpression
{
    private PExpression _l_;
    private PExpression _r_;

    public AOrExpressionExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOrExpressionExpression(
            cloneNode(this._l_),
            cloneNode(this._r_));
    }
    ...
    {
        ((Analysis) sw).caseAOrExpressionExpression(this);
    }
